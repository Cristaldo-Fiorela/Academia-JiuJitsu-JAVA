    ...
    return (
        <>
            <section className="w-auto flex flex-wrap justify-center text-slate-200 py-10 sm:py-0" id="banner">
                <img src={ JiuJitsu } alt="hombre de espaldas con kimono" className='sm:h-80' />
                <section className='flex flex-col justify-center items-center '>
                    ...
                    <h3 className='text-center py-5 text-2xl sm:text-xl lg:py-10 w-72'>Accede a nuestro contenido privado para alumnos y profesores.</h3>
